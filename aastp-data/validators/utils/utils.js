...
export function validateId(expectedId, actualId, context, errors) {
...
export function validateRange(min, max, context, errors) {
    if (
        typeof min !== "number" ||
        typeof max !== "number"
    ) {
...
export function validateSource(source, context, errors) {
    if (!source) {
...
export function validateHazardSource(source, context, errors) {
...
export function buildIdSet(collection) {
...
export function validateUniqueIds(collection, entityName, errors) {
    const seen = new Set();
...
export function validateUniqueProperty(collection, property, entityName, errors) {
